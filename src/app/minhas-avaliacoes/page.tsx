...
export default function MinhasAvaliacoes() {
  ...
  const carregarAvaliacoes = async () => {
    try {
      ...
      // ✅ Busca usando user_id (estrutura atual correta)
      ...
      // Buscar male_profiles
      const ids = Array.from(
        new Set(rows.map((a) => a.male_profile_id).filter(Boolean) as string[])
      )
